...
public class OrderController {
    ...
    public ResponseEntity<Integer> getCountOfUnassignedOrders(){
        Integer countOfOrders = orderService.unassignedCount();
    ...
    public ResponseEntity<Integer> getOrdersLeftAfterGivenTimeByPartnerId(@PathVariable String time, @PathVariable String partnerId){
        ...
        Integer countOfOrders = orderService.orderLeft(time,partnerId);
    ...
    public ResponseEntity<String> getLastDeliveryTimeByPartnerId(@PathVariable String partnerId){
        String time = orderService.getDeliveryTime(partnerId);;
    ...
    public ResponseEntity<String> deletePartnerById(@PathVariable String partnerId){
        ...
        orderService.delete(partnerId);
        //orderService.unassignedCount();
